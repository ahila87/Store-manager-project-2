...
public class StoreManager {
    ...
    public static String path = "C:\\Users\\ahila\\IdeaProjects\\StoreManager\\data\\store.db";
    ...
    public static StoreManager getInstance() {
        if (instance == null) {
            instance = new StoreManager("SQLite", "C:\\Users\\ahila\\IdeaProjects\\StoreManager\\data\\store.db");
        }
        return instance;
    }
